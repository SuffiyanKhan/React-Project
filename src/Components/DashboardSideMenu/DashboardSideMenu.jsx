...
function DashboardSideMenu() {
    ...
    return (
        <>
            <Button variant="light" className='ms-2 fw-bold' style={{ backgroundColor: 'transparent', border: 'none' }} onClick={handleShow}>
                <svg
            ...
            <Offcanvas show={show} onHide={handleClose}>
                <Offcanvas.Header closeButton>
                    <Offcanvas.Title>
                        <header className='sticky-top py-4 px-2 bg-white '>
                            <img src={logo} alt="" />
                        </header>
                    </Offcanvas.Title>
                </Offcanvas.Header>
